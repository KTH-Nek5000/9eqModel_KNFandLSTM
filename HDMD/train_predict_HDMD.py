"""
train_predict_HDMD.py
---------------------
This code train an HDMD model and uses it to predict
...
model_name = f'HDMD_{n_train}_{q}'
...
hdmd = HDMD(train, q, r_opt = False, er = 1e-5)
hdmd.fit()
